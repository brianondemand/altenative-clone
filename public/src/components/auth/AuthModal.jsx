    ...
    <div className="relative z-50">
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div
            className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transtion-all
            ...
            <div className="bg-white pb-4 pt-5">
              <div className="border-b border-b-gray-200 flex items-center justify-center relative pb-5">
                ...
                {userFound === null ? (
                  ...
                  <span>
                    {userFound === true ? "Login" : "SignUp"} {email}
                  </span>
                )}
              </div>
              <div className="p-5">
                <h3 className="text-xl pb-5">Welcome to Airbnb Finds KE</h3>
                {userFound === null && (
                  <FormInput
                    name="email"
                    placeholder="Email"
